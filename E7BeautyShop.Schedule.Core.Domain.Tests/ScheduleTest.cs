...
public class ScheduleTest
{
    ...
    public void Should_AddDayRest_WhenCalled_ShouldAddDayRestToList()
    {
        ...
        var schedule = new Core.Domain.Schedule(DateTime.Now, DateTime.Now.AddDays(7), professionalId, weekday, weekend);
    ...
    public void Should_ReturnsTrue_IfWeekday_WhenOfficeHourIsOnWeekday()
    {
        ...
        var schedule = new Core.Domain.Schedule(DateTime.Now, DateTime.Now.AddDays(1), new ProfessionalId(Guid.NewGuid()),
            new Weekday(_startWeekday, _endWeekday), new Weekend(_startWeekend, _endWeekend));
        var isWeekday = Core.Domain.Schedule.IsWeekday(officeHour);
    ...
    public void Should_AddOfficeHour_WhenNotDayRest()
    {
        ...
        var schedule = new Core.Domain.Schedule(DateTime.Now, dateTime, new ProfessionalId(Guid.NewGuid()),
            new Weekday(_startWeekday, _endWeekday), new Weekend(_startWeekend, _endWeekend));
        var officeHour = new OfficeHour();
